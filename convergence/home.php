...
<main>
	...
	<section>
		<div class="servicesSection">
			<h5><?php echo the_field('section3_title');?></h5>
			<div class="servicesTrio">
				...
				<div class="servicesColumn" id="secondColumn">
				...
				<div class="servicesColumn">
					<div class="servicesIcon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 259.4 204.7"><defs><style>
	...
	<section>
		<div class="servicesSection">
			<div class="workSection">
				...
				<p><?php echo the_field('section5_intro');?></p>
				<div class="homeAccordion" id="test">
					<h2><?php echo the_field('approach_1'); ?></h2>
					<div class="accordionCircle">
						<h2>+</h2>
					</div>
				</div>
				<div class="accordionText" id="accordion1">
					<p><?php echo the_field('approach1_text');?></p>
				</div>
				<div class="homeAccordion">
					<h2><?php echo the_field('approach_2'); ?></h2>
					<div class="accordionCircle">
						<h2>+</h2>
					</div>
				</div>
				<div class="accordionText" id="accordion2">
					<p><?php echo the_field('approach2_text');?></p>
				</div>
				<div class="homeAccordion">
					<h2><?php echo the_field('approach_3'); ?></h2>
					<div class="accordionCircle">
						<h2>+</h2>
					</div>
				</div>
				<div class="accordionText" id="accordion3">
					<p><?php echo the_field('approach3_text');?></p>
				</div>
				<div class="homeAccordion">
					<h2><?php echo the_field('approach_4'); ?></h2>
					<div class="accordionCircle">
						<h2>+</h2>
					</div>
				</div>
				<div class="accordionText" id="accordion4">
					<p><?php echo the_field('approach4_text');?></p>
				</div>
			</div>
		</div>
	</section>
